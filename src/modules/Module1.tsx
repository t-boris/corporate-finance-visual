 ...
 * Content: course objective, agency problems, governance, cash vs. profit,
 * the three core financial statements, and TVM (PV/FV, annuity, perpetuity).
 */
export function Module1Content() {
  return (
    <div className="space-y-8">
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <ConceptCard title="Objective: maximize shareholder value" icon={<Compass size={16} />} accent="#6366f1">
          <p>
            The principal goal of corporate finance is to <strong>maximize the long-term market value of the firm’s equity</strong>.
            This is not the same as maximizing earnings (which ignores risk and timing) or revenue
            (which ignores cost).
          </p>
          <p>
            A share price equals the <strong>present value of future cash flows</strong> available to shareholders,
            discounted at the required return that reflects risk.
          </p>
        </ConceptCard>

        <ConceptCard title="Agency problem & governance" icon={<Users size={16} />} accent="#06b6d4" index={1}>
          <p>
            Managers (agents) may act in their own interest rather than that of shareholders (principals):
            build empires through value-destroying M&amp;A, avoid risk, or consume perks.
          </p>
          <p>
            Governance tools include an <em>independent board</em>, <em>stock-based compensation</em>,
            the <em>threat of takeover</em>, <em>auditors</em>, and <em>activist investors</em>.
          </p>
        </ConceptCard>

        <ConceptCard title="Cash flow ≠ accounting profit" icon={<Coins size={16} />} accent="#10b981" index={2}>
          <p>
            Accounting profit depends on accounting policy (depreciation, accruals).
            Financial decisions are based on <strong>actual cash flows</strong> because only cash
            can be reinvested or paid out.
          </p>
        ...
        <ConceptCard title="The three financial statements" icon={<ScrollText size={16} />} accent="#f59e0b" index={3}>
          <p>
            <strong>Balance Sheet</strong> — snapshot of assets and financing: Assets = Liabilities + Equity.
          </p>
          <p>
            <strong>Income Statement</strong> — Revenue → Net Income over a period (includes non-cash items).
          </p>
          <p>
            <strong>Cash Flow Statement</strong> — reconciles Net Income into actual cash through three
      ...
      <section className="card p-5">
        <header className="mb-4">
          ...
          <h3 className="font-display text-lg font-semibold">Time Value of Money — the core formulas</h3>
        </header>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {[
            ...
            { name: 'PV of annuity',          formula: 'PV = C · [1 − (1+r)⁻ⁿ] / r',         hint: 'n equal payments' },
            { name: 'FV of annuity',          formula: 'FV = C · [(1+r)ⁿ − 1] / r',          hint: 'Accumulation' },
            { name: 'Perpetuity',             formula: 'PV = C / r',                          hint: 'Infinite payments' },
            { name: 'Growing perpetuity',     formula: 'PV = C / (r − g),  r > g',           hint: 'Gordon model' },
            { name: 'EAR (compounding m/yr)', formula: 'EAR = (1 + r/m)ᵐ − 1',               hint: 'Compare rates' },
            { name: 'Continuous compounding', formula: 'FV = PV · eʳᵗ',                      hint: 'Continuous limit' },
          ].map((f) => (
